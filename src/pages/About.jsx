...
const people = [
  ...
  },
  {
    ...
    bio: 'Rahul Fernandez is a Senior Research Assistant in the Department of Population Health Sciences at Weill Cornell Medicine, where he works with Dr Tyler Braun and collaborators on several data driven research avenues within the larger healthcare space. Rahul has a Masters of Science in Biostatistics and Data Science from Weill Cornell Medicine, and a Bachelors in Economics with a minor in Biology from Azim Premji University.',
  },
  {
    name: 'Yuting Fan',
    role: '',
    photo: '/bios/yuting-fan.jpg',
    bio: 'Yuting Fan is a software engineer with a background in data science, focused on building intelligence systems from complex public data. For this project, Yuting designed and implemented core components of a multi-source acquisition intelligence platform, developing data integration pipelines, entity resolution workflows, and automated validation processes that transform fragmented regulatory signals into reliable transaction intelligence. Yutings interests lie in building data-intensive systems that bridge software engineering, large-scale information integration, and real-world decision making.',
  },
];
