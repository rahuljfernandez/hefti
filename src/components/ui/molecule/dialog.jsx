...
export function Dialog({ size = 'lg', className, children, ...props }) {
  return (
    <Headless.Dialog {...props} className="relative z-[200]">
      <Headless.DialogBackdrop
        transition
        className="fixed inset-0 z-[200] flex w-screen justify-center overflow-y-auto bg-zinc-950/25 px-2 py-2 transition duration-100 focus:outline-0 data-closed:opacity-0 data-enter:ease-out data-leave:ease-in sm:px-6 sm:py-8 lg:px-8 lg:py-16 dark:bg-zinc-950/50"
      />

      <div className="fixed inset-0 z-[200] w-screen overflow-y-auto pt-6 sm:pt-0">
